...
const questions: Question[] = shuffleArray([
  ...
  // Ajoute ici le reste de tes questions de la même manière
]);
...
export default function QuizPage() {
  ...
  const [showBatchScore, setShowBatchScore] = useState<boolean>(false);
  ...
  return (
    <Userview>
      <div className="flex flex-col items-center justify-center text-center gap-6 min-h-screen">
